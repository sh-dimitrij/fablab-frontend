    ...
    return (
        <div>
            ...
            <div className={"menu-wrapper " + (isOpen ? "open" : "")}>
                ...
                <Link to="/works-list" className="menu-item" onClick={(e) => {setIsOpen(false)}}>
                    <span>Работы</span>
                </Link>

                {is_moderator &&
                    <Link to="/works-table" className="menu-item" onClick={(e) => {setIsOpen(false)}}>
                        <span>Таблица работ</span>
                    </Link>
                }
