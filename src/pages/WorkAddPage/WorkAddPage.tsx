...
const WorkAddPage = () => {
    ...
    const addWork = async () => {
        ...
        const response = await api.post(`works/create/`, {}, {
            headers: {
        ...
        if (response.status == 200){
            const work_id = response.data["id"]
            await updateWork(work_id)
        }
    ...
    const updateWork = async (work_id) => {
        ...
        const response = await api.put(`works/${work_id}/update/`, form_data, {
            headers: {
            ...
            <div className="right">
                ...
                <div className="info-container">
                    ...
                    <div className="buttons-container">
                        ...
                        <CustomButton bg={variables.green} onClick={addWork}>
                            Создать
                        </CustomButton>
